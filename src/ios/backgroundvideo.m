...
- (void) start:(CDVInvokedUrlCommand *)command
{
    ...
    self.webView.opaque = NO;
    self.webView.backgroundColor = [UIColor clearColor];
    [self.webView.superview insertSubview:self.parentView aboveSubview:self.webView];
    ...
    self.previewLayer.connection.videoOrientation = [self getCurrentOrientation];
    
    CALayer *rootLayer = [[self view] layer];
    [rootLayer setMasksToBounds:YES];
    [self.previewLayer setFrame:CGRectMake(0, 0, width, height)];
